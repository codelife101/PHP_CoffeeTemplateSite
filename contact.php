...
<h1 class="aboutTitle">GET IN TOUCH</h1>
	...
	<!-- 	 <label for="upload">Upload an Image</label>
		...
		<input type="submit"  class="px-3 rounded-pill submitBtn">
